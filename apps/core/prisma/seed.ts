...
async function main() {
  ...
  if (existingProducts === 0) {
    const demoProducts = [
      ...
      { name: "Mechanical Keyboard RGB", slug: "mechanical-keyboard-rgb", price: 3499, mrp: 5999, regularPrice: 3499, category: "Electronics", status: "draft", brand: "KeyCraft", rating: 4.6, reviews: 421, description: "Full-size mechanical keyboard with Cherry MX Blue switches. Per-key RGB backlighting. Aircraft-grade aluminum frame.", images: ["https://picsum.photos/600/600?random=7"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" },
      { name: "Yoga Mat 6mm Extra Thick", slug: "yoga-mat-6mm", price: 699, mrp: 1299, regularPrice: 699, category: "Sports", status: "published", brand: "FlexFit", rating: 4.3, reviews: 198, description: "Extra thick 6mm yoga mat with non-slip surface. Includes carrying strap. Eco-friendly TPE material.", images: ["https://picsum.photos/600/600?random=8", "https://picsum.photos/600/600?random=18", "https://picsum.photos/600/600?random=28"], videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4" },
    ];
